...
|---|---|---|---|---|---|---|
| 1 | A | 전광판으로 내릴역을 확인하기 어려울 것이다 | 인터뷰, 설문조사 |  |  |  |
| 2 | B | 약속 장소로 중간 지역을 선호할 것이다. 중간 지역 선정 과정에서 거리, 시간을 매번 파악하기 번거로울 것이다. | 인터뷰, 설문조사 |  |  |  |
| 3 | C | 야간 주행 중 주변 차량 파악이 어려워 사고 위험을 겪었을 것이다. | 인터뷰, 설문조사 |  |  |  |
